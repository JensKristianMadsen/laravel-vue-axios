...
<!--DateAuto
                  <div class="col-span-1 sm:col-span-1 lg:col-span-1">
                    <label for="date" class="block text-sm font-medium text-gray-700">DateAuto</label>
                    <input datepicker  v-model="item.day"  type="date" id="date_picker"  autocomplete="address-level1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  </div>
